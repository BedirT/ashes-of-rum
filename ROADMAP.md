...
| In Progress | 011 - Restructure the playable prototype | Preserve the complete current match while making each gameplay domain and test area small enough to understand and change safely. |
