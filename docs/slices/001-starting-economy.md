...
- Verification: exact-HEAD `make verify` evidence is recorded on the PR.
- Review: round 1 required fixer run 1; a context-free final-HEAD review is pending.
- Merge: pending final review and green-gate audit.
