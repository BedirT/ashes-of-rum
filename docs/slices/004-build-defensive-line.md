...
- Runtime proof: the exact-HEAD built player constructed a Storehouse and Watchtower, rerouted an
  assigned worker through the nearer Storehouse, fired a visible Watchtower projectile at the
  nearest hostile, preserved meaningful attackers through a moving assault, demolished completed
  buildings through confirmation, and retained gathering, House construction, formation training,
  and counter combat. The graphical capture was inspected for HUD, building, projectile, and
  formation clarity.
...
- Merge: squash-merged as `45f5dabb529690d33fc78875ea55a2b7ff6cfd8e`; `make post-merge`
  passed on merged `main` with the same 14 EditMode and 22 PlayMode tests, build, smokes, and log
  checks.
